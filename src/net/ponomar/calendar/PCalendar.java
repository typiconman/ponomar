...
//This creates a calendar object that will store the relate information about manipulating and dealing with different calendars and standards.
...
public class PCalendar implements Cloneable
{
	...
	private double difference; //Stores the associated difference in days between Julian and Gregorian calendars
        ...
        public Object clone()
	{
		return new PCalendar(date, type,Analyse.getDayInfo().clone());
	}
