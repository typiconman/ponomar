...
public final class Paschalion
{
	...
	public static JDate getPascha(int year) throws IllegalArgumentException
	{
		if (year < 33)
		{
	...
	// THROWS: IllegalArgumentException IF year < 33
	public static JDate getPentecost(int year) throws IllegalArgumentException
	{
		if (year < 33)
		{
			throw (new IllegalArgumentException("Invalid year"));
	...
	// THROWS: ditto
	public static int[] getFasts(int year) throws IllegalArgumentException
	{
		if (year < 33)
		{
			throw( new IllegalArgumentException("Invalid year"));
